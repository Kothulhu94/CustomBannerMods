...
namespace LivingLegend
{
    public class LivingLegendClanTierModel : DefaultClanTierModel
    {
        ...
        public override int GetCompanionLimit(Clan clan)
        {
            ...
            {
                int bonus = (int)((clan.Renown - _settings.RenownThreshold) / _settings.CompanionLimitRenownDivisor);
    ...
    public class LivingLegendMilitiaModel : DefaultSettlementMilitiaModel
    {
        ...
        public override ExplainedNumber CalculateMilitiaChange(Settlement settlement, bool includeDescriptions = false)
        {
            ...
            {
                result.Add(_settings.LegendMilitiaBonus, new TextObject("{=legend_militia}The Legend's Aura"));
            }
    ...
    public class LivingLegendLoyaltyModel : DefaultSettlementLoyaltyModel
    {
        ...
        public override ExplainedNumber CalculateLoyaltyChange(Town town, bool includeDescriptions = false)
        {
            ...
            {
                result.Add(_settings.LegendLoyaltyBonus, new TextObject("{=legend_loyalty}The Legend's Aura"));
            }
            return result;
        }
    }
