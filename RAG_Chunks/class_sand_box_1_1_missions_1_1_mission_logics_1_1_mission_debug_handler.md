--- SOURCE: class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html ---

SandBox.Missions.MissionLogics.MissionDebugHandler Class ReferenceInherits [TaleWorlds.MountAndBlade.MissionLogic](class_tale_worlds_1_1_mount_and_blade_1_1_mission_logic.html).

|  |  |
| --- | --- |
| Public Member Functions | |
| override void | [AfterStart](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#a19a3f15044ef88e53a1c2abfbc300d7a) () |
| override void | [OnMissionTick](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#ae42e910686c3f14056cdd1d70adca1c1) (float dt) |
| override void | [OnRemoveBehavior](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#a5961b6b08f39f224877af4ca9d462956) () |
| void | [SpawnCustom](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#a2d72045c71a81a09810d5ee598fc25d7) () |
...
| static void | [EquipmentDebugTick](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#aae9abdeefd7d7948a2d52843718c1734) () |
...
ImGUI Guide: You can read the ShowDebugInfo() function for basics. If you need to add a tab to the window, add a [Debug](class_tale_worlds_1_1_library_1_1_debug.html) Tab. You can see how they are used below. Every ImGUI element such as buttons, check boxes etc. requires boolean flags. Without those boolean flags, GUI elements may not work properly. You can use new ImGUI elements with those boolean flags and/or add new flags to new elements. There are helper ImGUI functions for TextArea, Checkbox, Button and Integer Input elements. Further elements can be found on Imgui.cs In order to open the debug window, you need to press CTRL + D and after that, CTRL + PageDown. Toggle mouse cursor with CTRL + ALT + Home \_smallButton is used to create a small button on ImGUIButton and \_normalButton is for normal. They are readonly booleans. Do not change them. Button function does not provide separator or onsameline, so you have to add them manually after button usage. \_separatorNeeded specifies if you need a separator element after an element. Readonly boolean. Do not change it. \_onSameLineNeeded specifies if you need two elements on the same line it affects current element and following element. Readonly boolean. Do not change it. Do Not Hide The Mouse Cursor When [Debug](class_tale_worlds_1_1_library_1_1_debug.html) Window Is Intersecting With The Center Of The Screen!

Member Function Documentation
-----------------------------

[◆](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#a19a3f15044ef88e53a1c2abfbc300d7a)AfterStart()
--------------------------------------------------------------------------------------------------------------------------------

|  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| |  |  |  |  |  | | --- | --- | --- | --- | --- | | override void SandBox.Missions.MissionLogics.MissionDebugHandler.AfterStart | ( |  | ) |  | | virtual |
...
[◆](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#ae42e910686c3f14056cdd1d70adca1c1)OnMissionTick()
-----------------------------------------------------------------------------------------------------------------------------------

|  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | override void SandBox.Missions.MissionLogics.MissionDebugHandler.OnMissionTick | ( | float | *dt* | ) |  | | virtual |
...
[◆](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#a5961b6b08f39f224877af4ca9d462956)OnRemoveBehavior()
--------------------------------------------------------------------------------------------------------------------------------------

|  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| |  |  |  |  |  | | --- | --- | --- | --- | --- | | override void SandBox.Missions.MissionLogics.MissionDebugHandler.OnRemoveBehavior | ( |  | ) |  | | virtual |
...
[◆](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#a2d72045c71a81a09810d5ee598fc25d7)SpawnCustom()
---------------------------------------------------------------------------------------------------------------------------------

|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| void SandBox.Missions.MissionLogics.MissionDebugHandler.SpawnCustom | ( |  | ) |  |

[◆](class_sand_box_1_1_missions_1_1_mission_logics_1_1_mission_debug_handler.html#aae9abdeefd7d7948a2d52843718c1734)EquipmentDebugTick()
----------------------------------------------------------------------------------------------------------------------------------------

|  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| |  |  |  |  |  | | --- | --- | --- | --- | --- | | void SandBox.Missions.MissionLogics.MissionDebugHandler.EquipmentDebugTick | ( |  | ) |  | | static |
